...
public class pesantiket extends AppCompatActivity {
    ...
    public void increment(View view) {
        if (quantity==100)
        {
            Toast.makeText(this, "You Cannot Have More Than 100 Ticket", Toast.LENGTH_SHORT).show();
            return;
        }
        quantity=quantity+1;
        display(quantity);
    ...
    public void decrement(View view) {
        if (quantity==1)
        {
            Toast.makeText(this, "You Cannot Have Less Than 1 Ticket", Toast.LENGTH_SHORT).show();
            return;
        }
        quantity=quantity-1;
        display(quantity);
    ...
    public void submitOrder(View view) {
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, "Tiket LRT : "+name);
    ...
    private String createOrderSummary (String name, int price, boolean addWhippedCream, boolean addChocolate){
        ...
        priceMessage += "\nBeli  Tiket per Stasiun : "+ addWhippedCream;
        priceMessage += "\nBeli Tiket Bandara SMB II : " + addChocolate;
        priceMessage += "\nBanyak Tiket : " + quantity;
